// Adapted from yuvraj0412s/ai-native-portfolio src/hooks/use-FluidCursor.tsx (MIT License).
function initFluidCursor(canvasSelector = '.ink-canvas') {
  ...
  if (!gl || !ext?.formatRGBA || !ext?.formatRG || !ext?.formatR) return;
...
window.initFluidCursor = initFluidCursor;
